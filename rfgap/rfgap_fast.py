...
def RFGAP_FAST(prediction_type = None, y = None, prox_method = 'rfgap', 
    ...
    **kwargs
    ...
    class RFGAP_FAST(rf):
        ...
        def __init__(self, prox_method = prox_method, matrix_type = matrix_type, 
            ...
            super(RFGAP_FAST, self).__init__(**kwargs)
        ...
        def get_proximities(self):
            ...
            # -----------------------------------------------------------------
                ...
                prox_sparse = inv_S_out_i_scaler @ prox_matrix_sum
                ...
                if self.non_zero_diagonal:
                    ...
                    self.min_diag = np.min(Diagonal_vec)
        ...
        def prox_extend(self, data, training_indices=None):
            ...
            # -----------------------------------------------------------------
                ...
                # 3. Apply Normalization to extended proximities (not recommended)
                if self.normalize:
                    if self.verbose:
    ...
    return RFGAP_FAST(prox_method = prox_method, matrix_type = matrix_type, triangular = triangular, **kwargs)
